        ...
        <div class="row">
            ...
            <div class="col-md-12 animate-box text-center mt-4" data-animate-effect="fadeInLeft">
                <ul class="social-network">
                    ...
                    <li><a target="_blank" href="{{ 'https://www.linkedin.com/in/'.$profile->linkedin }}"><i class="ti-linkedin font-25px mx-2"></i></a></li>
            ...
            <p class="techynaf-lead">&copy; <a target="_blank" href="https://techynaf.com/">TECHYNAF TECHNOLOGIES LIMITED</a></p>
            </div>
        </div>
    </div>
</div>
